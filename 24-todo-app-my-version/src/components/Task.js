...
function Task({ text, changeNumberComponents }) {
        ...
        <div className={doneComponent ? styles.taskDone : styles.task}>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (doneComponent === true) {
                changeNumberComponents.minus()
              }
            }}
          >
          ...
          <button
            className={doneComponent ? styles.buttonDone : styles.button}
            onClick={() => {
              setDoneComponent(!doneComponent)
              if (doneComponent === false) {
                changeNumberComponents.plus()
              } else if (doneComponent === true) {
                changeNumberComponents.minus()
              }
            }}
          >
